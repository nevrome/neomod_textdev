...
Das C++ Programm gluesless simuliert die Expansion von Ideen in einem Populationsgraphen wie er mittels des popgenerators erzeugt werden kann. gluesless macht sich die objektorientierte Natur von C++ zu Abbildung der Simulationswelt in vier Klassen zunutze (siehe Tabelle X). 
