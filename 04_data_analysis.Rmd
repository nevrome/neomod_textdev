...
tibble::tibble(
  ...
  description = c(
    ...
    "Namen der Ideen.",
    "Proportionaler Anteil der Ideen in jeder Region zum Startzeitpunkt der Simulation.",
    "Stärke der Ideen."
  ),
  values = c(
    ...
    "Vektor mit Namen.
    \\texttt{c('ideaA', 'ideaB')}",
    "\\textit{data.frame} mit Proportionen pro Gruppe und Idee. Eine Tabelle mit einer Zeile für jede Gruppe und einer Spalte für jede Idee. In den Zellen ist der Anteil der Idee in dieser Gruppe als Doublewert zwischen 0 und 1 angegeben. Die Zeilensumme muss 1 ergeben.
...
### Wertebereiche der Simulationsparameter
