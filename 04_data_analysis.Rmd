...
```{r sed-dev-matrix-bt, echo = FALSE, fig.scap = "Plotmatrix der Squared Euclidian Distance (SED) Beziehungen zwischen den Regionen für \\textit{burial type}", fig.cap = "huhu", out.extra = ""}
...
```{r sed-dev-matrix-bc, echo = FALSE, fig.scap = "Plotmatrix der SED Beziehungen für \\textit{burial construction}", fig.cap = "huhu", out.extra = ""}
...
```{r sed-mean-matrix-bt, echo = FALSE, fig.scap = "Matrix der durchschnittlichen SED Beziehungen für \\textit{burial type}", fig.cap = "huhu", out.extra = ""}
...
```{r sed-mean-matrix-bc, echo = FALSE, fig.scap = "Matrix der durchschnittlichen SED Beziehungen für \\textit{burial construction}", fig.cap = "huhu", out.extra = ""}
...
```{r sed-dev-bt, echo = FALSE, fig.scap = "Entwicklung der \\textit{burial type} SED für jede Region zu jeder anderen", fig.cap = "huhu", out.extra = ""}
knitr::include_graphics("../neomod_analysis/figures_plots/sed/regions_squared_euclidian_distance_burial_type.jpeg")
```

\@ref(fig:sed-dev-bc)

```{r sed-dev-bc, echo = FALSE, fig.scap = "Entwicklung der \\textit{burial construction} SED für jede Region zu jeder anderen", fig.cap = "huhu", out.extra = ""}
...
\begin{landscape}
```{r mantel-bt-bc, echo = FALSE, fig.scap = "\\textit{burial type} SED aufgetragen gegen \\textit{burial construction} SED für verschiedene Zeitschritte", fig.cap = "huhu", out.extra = ""}
...
```{r map-regions-distance-classes, echo = FALSE, fig.scap = "huhu", fig.cap = "huhu", out.extra = ""}
...
\begin{landscape}
```{r map-sed-bt, echo = FALSE, fig.scap = "huhu", fig.cap = "huhu", out.extra = ""}
...
\begin{landscape}
```{r map-sed-bc, echo = FALSE, fig.scap = "huhu", fig.cap = "huhu", out.extra = ""}
...
\begin{landscape}
```{r mantel-bt-spatial, echo = FALSE, fig.scap = "huhu", fig.cap = "huhu", out.extra = ""}
...
\begin{landscape}
```{r mantel-bc-spatial, echo = FALSE, fig.scap = "huhu", fig.cap = "huhu", out.extra = ""}
