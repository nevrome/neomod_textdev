...
Zur *Benelux* Region gehören hier die Niederlande, der Norden Belgiens und große Teile von Niedersachen und Nordrheinwestfalen. Aus all diesen Regionen liegen ^14^C Daten an Gräbern in Radon-B vor, die Datendichte in Belgien und den Niederlanden ist jedoch deutlich höher. Wie in *Southern Scandinavia* ist auch in der *Benelux* Region die Frühbronzezeit im Gegensatz zu Mittel- und Spätbronzeit unterrepräsentiert -- wenn auch in etwas schwächerer Form. Während die Informationsdichte der *burial type* Variable diesem Verlauf folgt, ist die *burial construction* in der Spätbronzezeit nahezu undokumentiert. Wie in der *Southern Germany* Region zeichnet sich auch hier eine gravierende Differenz zwischen der Informationsdichte beider Variablen ab.     
