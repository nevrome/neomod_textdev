...
Eine inhaltlich etwas reduzierte^[Für einen Überblick, welche Variablen heruntergeladen und wie umbenannt werden: https://github.com/ISAAKiel/c14bazAAR/blob/master/data-raw/variable_reference.csv], aber hier ausreichende Version von Radon-B wurde mittels des R Pakets c14bazAAR direkt in R bezogen. Der erste Schritt der Datenverarbeitung war die Kalibration der ^14^C-Daten. Dafür kam das R Paket Bchron^[@haslett_simple_2008] zum Einsatz. ... 
