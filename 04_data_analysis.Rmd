...
tibble::tibble(
  category = c("Allgemeine Parameter"),
  parameter = c("timeframe"),
  datatype = c("numeric vector"),
  description = c(
    "Huhu"
  ),
  values = c(
    "Beliebige, unterbrechungslose Sequenz von sukzessive aufeinander folgenden Integerwerten:
    \\texttt{-2200:-800}"
  )
) %>%
  dplyr::transmute(
