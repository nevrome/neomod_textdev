...
Der Arbeitsdatensatz, der nach oben beschriebenem Vorgehen zusammengestellt wurde, umfasst also 1.894 Einträge aus der Radon-B Datenbank. Die effektive Anzahl an ^14^C Daten, die diese Einträge wiedergeben, ist geringer: Eine Zählung der Labornummern ergibt XXX individuelle Werte. Diese Diskrepanz ergibt sich aus Einträgen mit keiner (*n/a-n/a*) oder unvollständiger (z.B. *MAMS-n/a*, *Gd-n/a*, *Ke-n/a*) Labornummer sowie Daten die mehrfach in die Datenbank eingegeben wurden (z.B. *OxA-29003*, *GrN-10754*, *BRAMS-1217*). Letzteres betrifft XXX Einträge, die ein und dasselbe ^14^C Datum zwei- oder mehrfach repräsentieren. Die Anzahl an Gräbern, die durch die Einträge repräsentiert werden ist noch geringer: Für XXX Einträge gilt, dass die ihnen zugehörige Kombination aus Fundplatz und Befund von mindestens einem weiteren Eintrag abgedeckt wird. Der wichtigste Grund dafür ist, dass für ein Grab häufig mehrere ^14^C Daten in Auftrag gegeben werden. 
