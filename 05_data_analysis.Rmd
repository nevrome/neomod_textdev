...
Die Störung und Beraubung von Gräbern war ein in Geschichte und Vorgeschichte weit verbreitetes Phänomen. Hügelgräber wurden dabei aufgrund ihrer guten Sichtbarkeit üblicherweise stärker angegriffen als Flachgräber und könnten infolge dessen in Radon-B unterrepräsentiert sein. Außerdem ist davon auszugehen, dass ein großer Teil der in der Bronzezeit errichteten Hügelgräber durch landwirtschaftliche Aktivität -- langjähriges Überpflügen -- zerstört wurde. Auch das ist Grund für eine Unterrepräsentation im gesamten archäologischen Befund. Andererseits: Wenn ein Hügelgrab noch vorhanden ist, dann ist es -- im Gegensatz zu einem Flachgrab -- leichter sichtbar und gerät eher in den Fokus archäologischer Aufmerksamkeit. Hügelgräber zeichnen sich oft eindeutig identifizierbar in Luftbildern oder digitalen Geländemodellen ab, während Flachgräber für heutige Methoden der Fernerkundung deutlich schwieriger zu erkennen sind. Gewissheit bringt oft erst eine Sondagegrabung. 

https://www.researchgate.net/post/Is_it_possible_and_if_how_to_find_out_with_radiocarbon_dating_or_other_methods_at_what_point_were_burned_human_remains
