...
```{r neiman-general, echo = FALSE, fig.scap = "Simulationsparameter: Populationsgröße & Zwischengruppenaustausch (Neiman Simulation)", fig.cap = "Simulationsparameter: Populationsgröße & Zwischengruppenaustausch (Neiman Simulation). Parameterexploration für eine Neiman-artige Simulation. Jeder Einzelplot (A, B, C, ...) präsentiert das Ergebnis von acht Simulationsdurchläufen mit einer Parameterkonstellation nach Vorlage der Abbildungen \\ref{fig:development-proportions-regions-burial-type} und \\ref{fig:development-proportions-regions-burial-construction}. In der Plotmatrix wird auf der X-Achse der Grad des Zwischengruppenaustauschs (0, 0.01, 0.1, 0.5, 1) und auf der Y-Achse die Populationsgröße (10, 50, 200) abgebildet.", out.extra = ""}
knitr::include_graphics("../neiman1995/static_plots/neiman_general.jpeg")
```

```{r sim-popsize-crossregions, echo = FALSE, fig.scap = "Simulationsparameter: Populationsgröße & Zwischengruppenaustausch", fig.cap = "Simulationsparameter: Populationsgröße & Zwischengruppenaustausch. Wie Abbildung \\ref{fig:development-proportions-regions-burial-construction}", out.extra = ""}
knitr::include_graphics("../neomod_analysis/figures_plots/simulation_parameter_exploration/popsize_crossregions.jpeg")
```

```{r sim-startprop-distancemat, echo = FALSE, fig.scap = "Simulationsparameter: Populationsgröße & Zwischengruppenaustausch", fig.cap = "huhu", out.extra = ""}
knitr::include_graphics("../neomod_analysis/figures_plots/simulation_parameter_exploration/startprop_distancemat.jpeg")
```

```{r sim-vertitrans, echo = FALSE, fig.scap = "huhu", fig.cap = "huhu", out.extra = ""}
