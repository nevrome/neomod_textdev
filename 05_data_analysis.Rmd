...
```{r sim-popsize-crossregions, echo = FALSE, fig.scap = "huhu", fig.cap = "huhu", out.extra = ""}
knitr::include_graphics("../neomod_analysis/figures_plots/simulation_parameter_exploration/popsize_crossregions.jpeg")
```

```{r sim-startprop-distancemat, echo = FALSE, fig.scap = "huhu", fig.cap = "huhu", out.extra = ""}
