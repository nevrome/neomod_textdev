...
Chronologieüberblick Abbildung \ref{fig:general-chronology}.

\begin{landscape}
\begin{figure}
\includegraphics{../neomod_analysis/figures_plots/chronology/bronze_age_europe_chronology} \caption[huhu]{huhu}\label{fig:general-chronology}
\end{figure}
\end{landscape}
