...
\caption{\label{tab:projects}Parameter, die in Radon-B für jedes Datum vorliegen.}
\centering
...
\caption{\label{tab:libraries}Parameter, die in Radon-B für jedes Datum vorliegen.}
\centering
\fontsize{8}{10}\selectfont
\begin{tabu} to \linewidth {>{\bfseries\raggedleft\arraybackslash}p{0.5em}>{\raggedright\arraybackslash}p{25em}}
\toprule
