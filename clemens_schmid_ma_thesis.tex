...
Zeile in diesem Datensatz enthält zunächst die Parameter -- später auch
die Ausgabedaten -- für eine Population, ihre Relationen und Ideen.
...
in Kapitel \ref{simulation-parameters} diskutiert.
...
@ref\{simulation-theorie\} beschrieben -- sehr einfach modelliert. Für
...
\texttt{population\_settings} Objekt wird eine Population generiert. Da
...
\texttt{unit\_settings} erzeugt. Zur Erzeugung einer Gruppe wird dieses
Objekt an die Funktion \texttt{generate\_unit} übergeben, die die
Hauptlast der Populationsgenerierung trägt.
