...
Teil ihres Buches formuliert sie Grundgedanken sehr bildhaft aus: Meme
sind das Ergebnis von \emph{Imitation}, \emph{Universeller Darwinismus}
greift wo immer \emph{Replikatoren} auftreten, Kulturentwicklung zieht
biologische Evolution an einer \emph{langen Leine} hinter sich her, Meme
haben Ähnlichkeit zu \emph{Krankheiten} und \emph{Computerviren}, Meme
haben -- zumindest statistisch -- Willen und Agency (\emph{the memes'
eye view}). Bevor sie diese Konzepte im Letzten Teil des Buches für
...
memetischer Perspektive zu. Dabei lässt sich ihre Perspektive auf eine
einfache Formel reduzieren: Sobald Meme existieren übernehmen sie die
Rolle des dominanten Replikators, der das Verhalten seiner Träger
