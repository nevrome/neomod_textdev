...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{# allow easy dynamic value integration}
\NormalTok{sf_desc <-}\StringTok{ "../neomod_analysis/data_analysis/desc_storage.txt"}
\NormalTok{r <-}\StringTok{ }\NormalTok{txtstorage}\OperatorTok{::}\NormalTok{read}
\end{Highlighting}
\end{Shaded}
...
(10956 Daten verblieben). Zur Kalibration wurde das R Paket
