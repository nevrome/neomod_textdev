...
oder die Entstehung von altruistischem Verhalten im Menschen\footnote{\textcite{boyd_origin_2005}
  ...
  Kooperation und \emph{Reziprozität} gewidmet}, soll hier aufgrund
seiner geringen Relevanz in diesem Kontext ignoriert werden. Ebenso die
Vielzahl von Ansätzen, moderne gesellschaftlichen Problemstellungen wie
...
Bedeutungsverschiebungen anwendbar. \emph{Horizontale} Transmission
spielt in der biologischen Vererbung eine untergeordnete Rolle und die
Übertragung erfordert große Anpassungen an den vor allem
\emph{vertikalen}, genetischen Ausgangsmodellen\footnote{\textcite{cavalli-sforza_cultural_1973};
...
Cultural Transmission und Cultural Evolution lassen sich unabhängig
voneinander erforschen -- eine Integration der Perspektiven bedeutet
aber für beide einen Zugewinn\footnote{\textcite{cavalli-sforza_cultural_1981},
  53-54}, denn: Ideen breiten sich nicht zufällig aus, verändern sich
nach erforschbaren Regeln und entfalten weitreichende Wirkung im
sozialen Raum ihrer Träger. Die Formen der Kommunikation, die für ihre
Ausbreitung zur Anwendung kommen sind vielfältig und entwickeln auf
...
Gruppen, wie die Kindererziehung (\emph{Vertical transmission}), Lehre
und Ausbildung von einer Generation zur nächsten (\emph{Oblique
transmission}) und der einfache Austausch von Information zwischen allen
Mitgliedern einer Population (\emph{Horizontal transmission}), wie er
durch Sprache, Schrift und Imitation permanent stattfindet.
...
praktisch zur Anwendung gebracht wurde. Ein umfassender
Literaturüberblick würde den Rahmen dieser Arbeit sprengen, dennoch
sollen einige wesentliche Leitlinien und Beiträge besonders der
vergangenen 20 Jahre genannt werden: \emph{Style Transmission}.
