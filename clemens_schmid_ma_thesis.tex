...
Großbritanniens einschließt. In Bretagne und Normandie war die
Errichtung von herausragenden Individualgrabhügel in Fortsetzung einer
Entwicklung, die schon seit der fortgeschrittenen Frühbronzezeit zur
Verkleinerung der Hügel geführt hatte, weiter rückläufig und wurde
schließlich eingestellt. Darüber hinaus sind die Bestattungspraktiken in
diesem Raum weitestgehend ein Desiderat. Im Nordosten wurden die
...
inspiriert (siehe Tabelle \ref{tab:projects}).

\begin{table}

\caption{\label{tab:projects}Die Projekte, die im Kontext der Entwicklung dieser Arbeit angelegt wurden.}
\centering
\begin{tabular}[t]{>{\raggedright\arraybackslash}p{20em}>{\raggedright\arraybackslash}p{25em}}
\toprule
Projekt & Beschreibung\\
\midrule
\textbf{neomod\_textdev}\newline \href{https://www.github.com/nevrome/neomod\_textdev}{github/nevrome/neomod\_textdev} & Textproduktion. Der Text der Masterarbeit wurde in R Markdown mit im bookdown Framework\tablefootnote{\textcite{xie_bookdown_2016}; \textcite{xie_bookdown_2018}} verfasst. Da ausschließlich das Rendern mittels Pandoc in LaTeX zu PDF vorgesehen war, enthält die Textvorlage auch vereinzelt LaTeX Ausdrücke. Jeder Commit löst dank Continous Integration mit Travis ein automatisches Rendern des Texts aus.\\
...
Das Modell und alle Analyswerkzeuge sind als Paket für die
Statistikprogrammiersprache R\footnote{\textcite{RCoreTeamLanguageEnvironmentStatistical2016}}
implementiert. Das eigentliche Modell ist mittels des
Rcpp-Frameworks\footnote{\textcite{eddelbuettel_extending_2017};
  \textcite{eddelbuettel_rcpp_2011};
  \textcite{eddelbuettel_seamless_2013}} in C++\footnote{\textcite{_iso/iec_2017}}
umgesetzt, um auf dessen höhere Geschwindigkeit und bessere Werkzeuge
für Objektorientiertes Programmieren zurückgreifen zu können. Daneben
enthält das Paket in R geschriebene Hilfsfunktionen zur
Datenaufbereitung, Analyse und Visualisierung. Getrennt von diesem R
Paket existiert ein zweites Repositorium (github/nevrome/\ldots{}), in
dem Modellrechnung und Auswertung für das bronzezeitliche Fallbeispiel
ausgeführt wurden. Ein Teil der Entwicklung fand zunächst hier statt,
wurde dann aber über generalisierte Funktionen in genanntes R Paket
übernommen und wird hier jetzt nur noch referenziert.

Zur Implementierung von Analyse und Hilfsfunktionen in R kamen neben
Funktionen aus Basispaketen auch eine große Anzahl von Community-Paketen
zum Einsatz. Dazu gehören \ldots{} \textbf{Nennen und Zitieren!}. Auch
bei der Umsetzung des Modells in C++ habe ich auf
Erweiterungsbibliotheken zurückgegriffen. Allem voran zu nennen ist
\textbf{Nennen und Zitieren!}.

Code und Daten für das Modell sind öffentlich und frei zugänglich. Alle
Ergebnisse können reproduziert werden. Eine Anleitung dafür findet sich
auf Github ().

Die wesentliche, technischen Arbeitsschritte zur Nutzung des Modell von
\emph{Datenbeschaffung und -Vorbereitung} über \emph{Modelldurchlauf}
und schließlich \emph{Ergebnisauswertung} seien im folgenden
überblicksartig beschrieben. Die innere Gliederung des Modells wurde
bereits weiter oben erläutert. Eine genaue Darstellung der
Funktionsweise einzelner Submodule unterbleibt im Rahmen dieser Arbeit.
...
sich die C14-Daten in RADON-B räumlich und zeitlich verteilen. Für
einzelne Regionen liegen für gewisse Zeiträume verhältnismäßig viele
...
\hypertarget{quellenkritik}{%
\subsection{Quellenkritik}\label{quellenkritik}}
