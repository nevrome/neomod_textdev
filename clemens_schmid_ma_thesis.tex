...
hier verzichtet werden\footnote{Viele Punkte werden etwa von Tim Tyler
  ...
  welchen Anklang Memetik in pseudo- und grenzwissenschaftlichen Sphären
  gefunden hat}. Nur drei Angriffspunkte sollen herausgegriffen werden,
die von verschiedenen Kritikern wiederholt wurden und die ich zusammen
für besonders wichtig erachte, den Niedergang der Memetik zu erklären.
...
\item
  ...
  Perspektive war Stephen Jay Gould (*1941 - †2002).
\end{enumerate}
...
\item
  ...
  Erkenntnis brachte der Memetik den Todesstoß. Cultural evolution
  theory entwickelte sich permanent weiter, die Bezugnahme auf den Meme
  Begriff war allerdings minimal -- er scheint schlicht nicht
  erforderlich zu sein und keinen nennenswerten Vorteil für die
  Beschreibung von Kulturprozessen zu bieten.
\end{enumerate}
