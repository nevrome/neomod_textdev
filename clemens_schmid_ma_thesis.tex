...
Dem Modell liegen drei strukturgebende Gedanken und Anhaltspunkte
zugrunde:
...
Prozesse \emph{Drift} und \emph{Flow} (siehe Kapitel
\ref{stylistic-variability}). Die vorliegende Simulation sollte
mindestens diese Prozesse auch zeigen. \textbf{3.} Neimans Beitrag
demonstriert auch, wie ein solches Modell als archäologisches Werkzeug
sinnvoll für die Beurteilung kultureller Distanzmaße eingesetzt werden
kann. Kapitel \ref{cultural-and-spatial-distance} greift diesen Ansatz
für das Fallbeispiel bronzezeitlicher Bestattungssitten auf.
