...
Transmission müssen also alle Modi der Migration von der
Völkerwanderung, über den Frauentausch in Heiratsnetzwerken bis hin zum
alleine wandernden Händler und Handwerker gezählt werden. Daneben stehen
Prozesse innerhalb kohärenter Gruppen, wie die Kindererziehung
(\emph{Vertical transmission}), Lehre und Ausbildung von einer
Generation zur nächsten (\emph{Oblique transmission}) und der einfache
Austausch von Information zwischen allen Mitgliedern einer Population
(\emph{Horizontal transmission}), wie er durch Sprache, Schrift und
Imitation permanent stattfindet.
