...
Chronologieüberblick Abbildung \ref{fig:general-chronology}\footnote{Die
  ...
  \textcite{roberts_old_2013}. Dabei wurde auf folgende
  Quellenpublikationen zurückgegriffen: \textcite{burgess_bronze_1974};
  \textcite{burgess_age_1980}; \textcite{needham_chronology_1996};
  \textcite{needham_first_2010}; \textcite{needham_independent_1997};
  \textcite{lanting_14c-chronologie_2001};
  \textcite{gerloff_atlantic_2010}; \textcite{gerloff_reineckes_2007};
  \textcite{eogan_accomplished_1994}; \textcite{brindley_dating_2007};
