...
Tod und Ritual beleuchten, ohne allerdings Bestattungsriten aus Cultural
...
aufzustellen und zu prüfen. Rituale lassen sich grundsätzlich
hinsichtlich zweier Dimensionen kategorisieren: Häufigkeit des
regelmäßigen Wiederholens (\emph{frequency}) und Intensität der Wirkung
auf die Teilnehmer (\emph{arousal}). Kleine, homogene Gruppen
praktizieren eher seltene (\emph{low-frequency}), aber eindrücklichen
(\emph{high-arousal}) Rituale, während größere, stärkere sozial
zentralisierte Populationen zu häufigeren (\emph{high-frequency}), aber
weniger emotionalen (\emph{low-arousal}) Ritualen tendieren.
Gruppengröße und Struktur korrelieren also mit der Natur der in einer
Gesellschaft verbreiteten Rituale. Die emotionale Erregung, die mit
einem Ritual einhergeht ist im Bevölkerungsdurchschnitt in der Regel
entweder positiv oder negativ, also mit Euphorie oder Dysphorie
assoziiert. Der Übergang von einer wildbeuterischen zu einer
landwirtschaftlichen und dann zu einer komplexer stratifizierten
Gesellschaftsstruktur scheint mit einer Zunahme häufiger und
niederschwellig negativ konnotierter Rituale einherzugehen.

Bestattungen sind emotional negativ aufgeladene Rituale, die je nach
Gruppengröße mehrmals im Jahr, aber unregelmäßig stattfinden.
...
Repräsentativverhalten wie Tieropfer, rituelle Verstümmelung oder
Märtyrertum. Henrich erklärt diese Phänomene aus Cultural Evolution
...
verknüpft ist. Demnach bevorzugen Lernende diese Form der Kommunikation
und erzeugen Selektionsdruck hin zu aufwändigen Demonstrationen von
Authentizität. Henrich demonstriert die Konsequenzen dieses Modells in
einer computerbasieren Simulation, die relavante Parameter besser
zugänglich macht. Die Konkurrenz zwischen Gruppen und Institutionen
innerhalb von Gruppen scheint ein wichtiger Anreiz zur Konsolidierung,
Intensivierung und Ritualisierung teuren Repräsentativverhaltens zu
sein. Diese Rituale werden häufig in Ideologien eingepasst, die den
Gruppenzusammenhalt stärken und der Gruppe insgesamt dienen.
...
Grabhügels ist mit einer großen Investition von Zeit und Arbeitskraft
verbunden. Diese Aufbauten und damit zusammenhängende Handlungen
adressieren die gesamte Gruppe -- und Rezipienten darüber hinaus (siehe
Kapitel \ref{grave-architecture}). Henrichs Beobachtungen zur
gruppeninternen Wirkung kostenintensiver Rituale gelten somit sicher in
besonderer Weise für Bestattungssitten.
...
zu formulieren. Ethnographische Beispiele zeigen, dass Menschen häufig
am intensivsten um junge Erwachsene trauern und entsprechend Gräber für
diese Altersgruppe besonders bewusst und komplex gestalten. MacDonald
sieht hier einen funktionalen Zusammenhang zwischen Trauer,
Arbeitskapazität und Reproduktionsfähigkeit, der für seine Fallstudie an
der präkolumbisch-indianischen Hohokam als Erklärungsmodell für die
Unterschiede der Bestattungsrituale in Frage kommt.
...
unerklärlich großer Beigabenmenge ausgestattet werden. Sein Ansatz ist
das Resultat eines Ansatzes, der Bestattungssitten funktionale und
kognitive zu erklären versucht und dabei die Komplexität menschlichen
Kulturverhaltens beiseite lässt.
