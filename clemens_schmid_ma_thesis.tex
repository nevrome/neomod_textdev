...
Der effektive Arbeitsdatensatz, der nach oben beschriebenem Vorgehen
zusammengestellt wurden, umfasst 1.749 Einträge aus der Radon-B
Datenbank. Die effektive Anzahl an \textsuperscript{14}C Daten ist
geringer: Eine Zählung der Labornummern ergibt 1650 individuelle Werte.
Diese Diskrepanz ergibt sich aus Einträgen mit keiner (\emph{n/a-n/a})
oder unvollständiger (z.B. \emph{MAMS-n/a}, \emph{Gd-n/a},
\emph{Ke-n/a}) Labornummer sowie Daten die mehrfach in die Datenbank
eingegeben wurden (z.B. \emph{OxA-29003}, \emph{GrN-10754},
\emph{BRAMS-1217}). Letzteres betrifft 110 Einträge, die ein und
dasselbe \textsuperscript{14}C Datum zwei- oder mehrfach repräsentieren.
Die Anzahl an Gräbern, die durch die Einträge repräsentiert werden ist
noch geringer: Für 514 Einträge gilt, dass die ihnen zugehörige
Kombination aus Fundplatz und Befund von mindestens einem weiteren
Eintrag abgedeckt wird. Der wichtigste Grund dafür ist, dass für ein
Grab häufig mehrere \textsuperscript{14}C Daten in Auftrag gegeben
werden.
...
(cremation: 161, inhumation: 108, unknown: 245) und \emph{burial
construction} (flat: 85, mound: 84, unknown: 345) keine starken
