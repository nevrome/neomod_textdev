...
dass überhaupt keine Aussage mehr für sie abgeleitet werden kann.
...
\emph{burial type} gibt die realen Verhältnisse näherungsweise wieder:
Körperbestattungen waren bis in die Spätbronzezeit in Westpolen
...
immerhin die richtige Tendenz an: Die Dominanz von Flachgräbern wird von
Hügelbestattungen abgelöst. Zur Spätbronzezeit lässt der Datensatz keine
Aussagen zu.
...
belegt. \emph{burial type} und \emph{burial construction} zeichnen diese
Entwicklung beide in etwa gleichem Umfang nach.
...
gut auf Jütland, Fünen und die schwedische Skåne Region verteilt. Sie
stammen vornehmlich aus Mittel- und Spätbronzezeit, die entsprechend
vergleichsweise gut hinsichtlich der beiden Variablen \emph{burial type}
und \emph{burial construction} erschlossen ist. Die Frühbronzezeit ist
dagegen ein Desiderat -- obgleich auf höherem Niveau als beispielsweise
\emph{Northeastern France}.
...
Verlauf folgt, ist die \emph{burial construction} in der Spätbronzezeit
...
Informationsdichte beider Variablen ab.
