...
entfernen. Radon-B stellt im Paramter \emph{Feature Type}
...
Statt des Parameters \emph{Feature Type} wurden mittels Pattern Matching
zwei neue Parameter mit jeweils drei Werten geschaffen:
...
Das Forschungsareal dieser Arbeit folgt keinen natürlichen oder
...
liegt ist bewusst mit EPSG:102013 -- Europe Albers Equal Area Conics
gewählt, da diese auch auf kontinentalem Maßstab und bei Landmassen in
betonter Ost-West Ausdehnung ein hohes Maß an Flächentreue
gewährleistet\footnote{\textcite{snyder_map_1987}, 98-99.}. Das ist eine
wichtige Eigenschaft für die Definition von vergleichbaren, räumlichen
