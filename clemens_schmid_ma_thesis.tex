...
Steppengebieten, dem Ostbalkan und dem östlichen Mittelmeergebiet. Die
slowakische, bronzezeitliche Chronologie folgt dem Schema nach Reinecke,
in Ungarn dagegen ist ein an der Tellsiedlung Toszeg erarbeitetes
Chronologieschema verbreitet. Eine Aufteilung in Früh-, Mittel-, Spät
und Endbronzezeit ist jedoch in beiden Kontexten gebräuchlich und kann
Grenzenüberschreitend zur Anwendung gebracht werden\footnote{\textcite{markova_slovakia_2013},
  813-814.}.

In der Frühbronzezeit \ldots{}

\footnote{\textcite{markova_slovakia_2013}, 814-825.}.

\footnote{\textcite{markova_slovakia_2013}, 825-827.}.

\footnote{\textcite{markova_slovakia_2013}, 827-833.}.
